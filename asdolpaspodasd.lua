...
silent_aim.crossbool = false
silent_aim.crosscolor = Color3.fromRGB(255,255,255)
local crosssizeog = UDim2.new(0.017, 0, 0.03, 0)
silent_aim.crosssizek = 2
silent_aim.crossrot = 0
silent_aim.crossimg = "rbxassetid://15574540229"
